  ...
  return (
    <div className="login-page">
      <div className="login-container">
        ...
        {state === 'ServiceProviderSignUp' && (
          <ServiceProviderSignUpForm navigate={navigate} setError={setError} />
        )}
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate('/profile', { state: { userType: 'customer' } });
      }
    } catch (err) {
...
const ServiceProviderSignUpForm = ({ navigate, setError }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        navigate('/profile', { state: { userType: 'serviceProvider' } });
      }
    } catch (err) {
  ...
  <button
    type="button"
    onClick={() => setFormData({ ...formData, availability: [...formData.availability, { day: '', startTime: '', endTime: '' }] })}
  >
...
// Login Form (with fixed forgot password navigation)
const LoginForm = ({ navigate, setError }) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        if (response.data.userType === 'admin') {
          ...
          navigate('/profile', { state: { userType: response.data.userType } });
        }
      }
    } catch (err) {
  ...
  //  Navigate to proper forgot password page
