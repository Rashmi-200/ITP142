...
export const loginServiceProvider = async (req, res) => {
    ...
    try {
        ...
        return res.status(200).json({ success: true, message: 'Login successful', token, userType: 'serviceProvider', email: serviceProvider.email });
...
export const uploadCertification = async (req, res) => {
    try {
        ...
        serviceProvider.certificationProofs.push(req.file.filename);
